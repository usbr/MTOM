...
## plot 
pdf(paste0('Powell_MTOM_Example.pdf'), width=9, height=6)
...
###### RESUME PLOT DEVELOPMENT HERE ##########

variable = title  = "PowellCyRel"
y_lab = "Outflow"
title = "Powell CY Release"
...
variable = "PowellWyRel"
y_lab = "Outflow"
title = "Powell WY Release"
...
variable = "PowellMayRel"
y_lab = "Outflow"
title = "Powell May Release"
...
#read the MTOM rwd_agg table I created #### VERIFY LB Surplus, only found Flood Control Slot
setwd(paste0(MTOMDIR,"/rdfOutput/"))
sys_rwa <- rwd_agg(read.csv("MTOM_sys_rwa.csv", stringsAsFactors = FALSE)) #read in a table I definted in excel
